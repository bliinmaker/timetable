...
from timetable_app.models import (Faculty, Group, Lesson, Student, Subject,
                                  Teacher)
from timetable_app.serializers import (FacultySerializer, GroupSerializer,
                                       LessonSerializer, StudentSerializer,
...
subject = Subject.objects.create(title='Химия')


# LessonViewSetTest = create_viewset_test(
#     Lesson, '/rest/lessons/', {
#         'subject': subject.id,
#     })
...
# GroupViewSetTest = create_viewset_test(
#     Group, '/rest/groups/', {
#         'title': 'HN-24-23',
#     })
